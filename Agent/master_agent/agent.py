...
from sub_agents.prompt.agent import prompt_enhancer
from sub_agents.fetchData.agent import fetchData_agent
from sub_agents.chartered.agent import chartered_agent
from sub_agents.data_analyst.agent import data_analyst_agent
from sub_agents.predictive_model.agent import predictive_model_agent
...
master_agent = Agent(
    ...
    **Your Logic:**
    ...
    0. If the user greets then quickly greet them back and ask how you can help. No need to carry out any action.
    0. If the user asks for help, greet them and ask how you can assist
    ...
    6.  **Final Step:** After the appropriate agent responds, synthesize all the information, greet the user, and present the final comprehensive financial analysis, prediction, or plan in a clear, well-formatted way. 
      ...
      **Your Response Should:** be concise, actionable, and tailored to the user's specific financial goals and context. Use clear headings, bullet points, and structured data where appropriate to enhance readability and understanding. Do not make the resonse too verbose or complex.
